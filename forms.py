...
class FormProveedor(FlaskForm):
    nombreProveedor = StringField('Nombre de la Editorial:', validators=[DataRequired()])
    direccion = StringField('Direccion:', validators=[DataRequired()])
    enviar = SubmitField('Enviar')


class FormProducto(FlaskForm):
    nombreProducto = StringField('Manga:', validators=[DataRequired()])
...
class ImageForm(FlaskForm):
    ...
    idProducto = SelectField('Manga:',choices=[],coerce=int,validators=[DataRequired()])
    enviar = SubmitField('Enviar')